...
3. Open `/admin`, issue a wallet-bound beneficiary credential, and export JSON or an encrypted QR payload.
...
6. Open `/receipt`, paste the receipt JSON, and verify the transaction hash against Stellar testnet.
